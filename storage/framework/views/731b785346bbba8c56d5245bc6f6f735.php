                        ...
                        <div class="table-responsive">
                            ...
                            <div>
                                ...
                                <div class="d-flex gap-2 mb-3 flex-wrap">
                                    <a href="<?php echo e(route('admin.donations.index', ['period' => 'today'])); ?>"
                                        class="btn btn-sm <?php echo e(request('period') === 'today' ? 'btn-primary' : 'btn-outline-secondary'); ?>">
                                        Today
                                    </a>
                                    <a href="<?php echo e(route('admin.donations.index', ['period' => 'weekly'])); ?>"
                                        class="btn btn-sm <?php echo e(request('period') === 'weekly' ? 'btn-primary' : 'btn-outline-secondary'); ?>">
                                        This Week
                                    </a>
                                    <a href="<?php echo e(route('admin.donations.index', ['period' => 'monthly'])); ?>"
