                    ...
                    <form class="row g-3 needs-validation" action="<?php echo e(route('admin.campaignlist.store')); ?>"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control" id="name"
                                value="<?php echo e(old('name')); ?>" maxlength="100" required>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="description" class="form-control row-3" id="description" maxlength="500" rows="3"><?php echo e(old('description')); ?></textarea>
                            <div class="valid-feedback">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="number" step="0.01" min="1" name="goal_amount" class="form-control"
                                    id="goal_amount" value="<?php echo e(old('goal_amount')); ?>"
                            ...
                            <select class="form-select" id="status" name="status" required>
                                <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($statusOption); ?>"
                                        <?php echo e(old('status', 'Draft') == $statusOption ? 'selected' : ''); ?>>
