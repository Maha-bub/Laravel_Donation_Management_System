                ...
                <div class="card bg-globe-img  h-100 shadow-sm">
                    <div class="card-body d-flex flex-column justify-content-center">
                        ...
                        <h2 class="fw-bold mt-3 mb-2">
                            <?php echo e(number_format((float) $totalRaised, 2)); ?>
                        ...
                        <div class="card h-100 shadow-sm bg-corner-img">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h3 class="mb-0"><?php echo e($totalCampaigns); ?></h3>
                                </div>
                        ...
                        <div class="card h-100 shadow-sm bg-corner-img">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h3 class="mb-0 text-success"><?php echo e($activeCampaigns); ?></h3>
                                </div>
                        ...
                        <div class="card h-100 shadow-sm bg-corner-img">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h3 class="mb-0 text-danger"><?php echo e($totalDonors); ?></h3>
                                </div>
...
<?php echo $__env->make('admin.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel_Donation_Management_System\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>