                        ...
                        <div class="about-left-item">
                            <div class="section-title style-2 mb-0">
                                ...
                                <h2 class="wow fadeInUp" data-wow-delay=".3s">
                                    <span>B</span>uilding futures one step at a time celebrating the wonder <br> of
                                    childhood.
                                </h2>
                            </div>
                            <p class="text wow fadeInUp" data-wow-delay=".5s">
                                ...
                                restaurant that serves delicious, beautifully presented dishes with impeccable service, look
                                no further.
                            </p>
                            <div class="about-image wow img-custom-anim-left" data-wow-duration="1.3s"
                                data-wow-delay="0.3s">
                                <img src="{{ asset('') }}frontent-assets/img/home-2/about/01.jpg" alt="img">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="about-right-item">
                            <div class="about-image wow img-custom-anim-right" data-wow-duration="1.3s"
                                data-wow-delay="0.3s">
                                <img src="{{ asset('') }}frontent-assets/img/home-2/about/02.jpg" alt="img">
                            </div>
                            <div class="about-icon-main-item">
                                <div class="about-icon-item">
                                    <div class="icon-item wow fadeInUp" data-wow-delay=".3s">
                                        <div class="icon">
                                            <img src="{{ asset('') }}frontent-assets/img/home-2/icon/01.svg" alt="img">
                                        </div>
                                        <div class="content">
                                            <h5>Healthy Food</h5>
                                            <p>
                                ...
                                <div class="about-icon-item mb-0">
                                    <div class="icon-item wow fadeInUp" data-wow-delay=".3s">
                                        <div class="icon">
                                            <img src="{{ asset('') }}frontent-assets/img/home-2/icon/03.svg" alt="img">
                                        </div>
                                        <div class="content">
                                    ...
                                    <div class="icon-item wow fadeInUp" data-wow-delay=".5s">
                                        <div class="icon">
                                            <img src="{{ asset('') }}frontent-assets/img/home-2/icon/04.svg" alt="img">
                                        </div>
                                        <div class="content">
                                            <h5>Community</h5>
                                            <p>
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <p>
                                                ...
                                                and shared responsibility in society.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="faq-content">
                            ...
                            <p class="text wow fadeInUp" data-wow-delay=".5s">
                                ...
                                responsibility in society. It reminds us of the can make it your significant difference in
                                someone's life.
                            </p>
                ...
                <div class="row g-4">
                    <div class="col-lg-5 wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                        <div class="testimonial-image">
                            ...
                            <div class="shape">
                                <img src="{{ asset('') }}frontent-assets/img/home-1/testimonial/shape.png" alt="img">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="content">
                                            ...
                                            <p>
                                                ...
                                                with impeccable service, look no further. I will definitely be returning
                                                soon to try more of their culinary delights”
                                            </p>
                                            <h3>Jonny Ananta</h3>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="brand-image text-center">
                                            <img src="{{ asset('') }}frontent-assets/img/home-1/brand/01.png" alt="img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="brand-image text-center">
                                            <img src="{{ asset('') }}frontent-assets/img/home-1/brand/02.png" alt="img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="brand-image text-center">
                                            <img src="{{ asset('') }}frontent-assets/img/home-1/brand/03.png" alt="img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="brand-image text-center">
                                            <img src="{{ asset('') }}frontent-assets/img/home-1/brand/04.png" alt="img">
                                        </div>
                                    </div>
                                </div>
                            </div>
